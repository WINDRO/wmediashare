...
bot.on('guildMemberAdd', member => {
    ...
    if(guild1 == guild.id) {
      add.send(`Salut ${member}, bienvenue sur le serveur **${guild.name}**! Si tu invites 10 membres sur ce discord avec ta propre invitation et tu recevra automatiquement un grade V.I.P !`);
    } else {
      return
    }
    });
