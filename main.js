...
bot.on('guildMemberAdd', member => {
    ...
    if(guild1 == guild.id) {
      add.send(`Salut ${member}, bienvenue sur le serveur **${guild.name}**! Pense à participer au <#410523247503736852> pour tenter de gagner une énorme pub pour ton serveur discord !`);
    } else {
      return
    }
    });
